...
function BillingSection() {
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 bg-[var(--secondary)]/10 border border-[var(--secondary)] rounded-lg">
        <p className="text-sm font-medium">Current Plan: <span className="text-[var(--secondary)]">Pro</span></p>
        <p className="text-xs text-[var(--muted)] mt-1">Next billing date: Jan 15, 2025</p>
      </div>
      <button className="px-6 py-2 border border-[var(--secondary)] text-[var(--secondary)] rounded-lg text-sm font-medium">Manage Subscription</button>
    </div>
  )
}
